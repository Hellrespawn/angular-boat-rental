...
export class SkipperController {
    ...
    public async getSkippers(req: express.Request, res: express.Response): Promise<void>{
        try {
    ...
    public async addSkipper(req: express.Request, res:express.Response):Promise<void> {
